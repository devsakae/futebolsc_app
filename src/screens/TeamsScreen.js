    ...
    <View style={styles.container}>
      ...
      >
        <Text style={styles.selectorText}>
          {selectedTeam || (teamsLoading ? 'CARREGANDO TIMES...' : 'SELECIONE UM TIME')}
        </Text>
      ...
      {loading ? (
        ...
        <View style={styles.centerContainer}>
          <Text style={styles.instructionText}>ESCOLHA UM TIME PARA VER O CALENDÁRIO COMPLETO</Text>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  selectorText: { ...Typography.titleLg, color: Colors.onSurface, fontSize: 16 },
